...
-- Animation Data (keeping original structure)
local Animations = {
    Idle = {
...
-- Animation Functions (keeping all original functions)
...
Notify("Changelog", "New Modern UI Design!", 30)
...
print("✅ GAZE Animation Hub v2.0 Loaded Successfully!")
